...
;// CONCATENATED MODULE: external {"commonjs":"sortablejs","commonjs2":"sortablejs","amd":"sortablejs","root":"Sortable"}
var external_commonjs_sortablejs_commonjs2_sortablejs_amd_sortablejs_root_Sortable_namespaceObject = require("sortablejs");
var external_commonjs_sortablejs_commonjs2_sortablejs_amd_sortablejs_root_Sortable_default = /*#__PURE__*/__webpack_require__.n(external_commonjs_sortablejs_commonjs2_sortablejs_amd_sortablejs_root_Sortable_namespaceObject);
...
var console_console = getConsole();
...
function getComponentAttributes(_ref3) {
  ...
  var attributes = project( // eslint-disable-next-line no-unused-vars
...
function getValidSortableEntries(value) {
  return Object.entries(value) // eslint-disable-next-line no-unused-vars
...
function getRootInformation(tag) {
  ...
  return {
    ...
    tag: externalComponent ? (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.resolveComponent)(tag) : transition ? external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.TransitionGroup : tag
  };
}
...
var draggableComponent = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.defineComponent)({
  ...
  render: function render() {
    try {
      ...
      return componentStructure.render(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.h, attributes);
    } catch (err) {
      this.error = true;
      return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.h)("pre", {
        style: {
          color: "red"
        }
      }, err.stack);
  ...
  created: function created() {
    if (this.list !== null && this.modelValue !== null) {
      console_console.error("modelValue and list props are mutually exclusive! Please set one or another.");
    }
  },
  mounted: function mounted() {
    ...
    this._sortable = new (external_commonjs_sortablejs_commonjs2_sortablejs_amd_sortablejs_root_Sortable_default())(targetDomElement, sortableOptions);
...
/* harmony default export */ var entry_lib = (vuedraggable);
